...
### NekoBox
请先在浏览器中打开以下地址，复制内容后回到代理软件中，点击右上角添加-“手动输入”-“自定义配置”，并在自定义配置中粘贴复制的内容。

`https://bot-api.otmdb.cn/maimai/proxy-config/nekobox`
...
`https://bot-api.otmdb.cn/maimai/proxy-config/throne`
